...
We obtained the final lifted coordinates based on lifover coordinates and, when absent, closer minimap2 hit:
```r
# module load R/4.0.1
library(dplyr)
library(tidyr)
